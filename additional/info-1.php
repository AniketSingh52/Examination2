            ...
            <div class="col-lg-9">
                <div class="login">
                    <form>
                        ...
                        <a href="allotment/allotment.php" class="btn btn-lg btn-block btn-danger ">Allocate duty</button></a><br>
                        <a href="display/display.php" class="btn btn-lg btn-block btn-danger">Display supervision chart</button></a><br>
                    </div>
